...
export const Slider = ({index, children: current, prev, next, setIndex}: SliderProps) => {
    const hasPrev = !!prev;
    const hasNext = !!next;
            ...
            <Animated.View style={StyleSheet.absoluteFill}>
                ...
                {prev && (
                    <Animated.View style={[StyleSheet.absoluteFill, leftStyle]}>
                        ...
                        <LiquidButton position={left} side={Side.LEFT} activeSide={activeSide} />
                    </Animated.View>
                )}
                {next && (
                    <Animated.View style={StyleSheet.absoluteFill}>
                        ...
                        <LiquidButton position={right} side={Side.RIGHT} activeSide={activeSide} />
                    </Animated.View>
                )}
            </Animated.View>
        </PanGestureHandler>
